...
const TOKEN_NAME = "FRAUD";
const TOKEN_SYMBOL = "SBF";
const TOKEN_DESCRIPTION = "A token for scammers";
const TOKEN_IMAGE_NAME = "download.png"; // Replace  your image name
const TOKEN_IMAGE_PATH = `tokens/sbf/assets/${TOKEN_IMAGE_NAME}`;

async function createsbfToken(
...
async function main() {
  ...
  await createsbfToken(connection, payer);
}
